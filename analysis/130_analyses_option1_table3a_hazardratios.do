...
tempname hazardratios
	postfile `hazardratios' outindex groupindex str30(outcome) str30(refgroup) hr1 hr1_lo hr1_hi hr2 hr2_lo hr2_hi hr3 hr3_lo hr3_hi using $resultsdir/option1_table3a_hazardratios.dta, replace
	local outindex=0
...
use $resultsdir/option1_table3a_hazardratios.dta, clear
...
save $resultsdir/option1_table3a_hazardratios.dta, replace
