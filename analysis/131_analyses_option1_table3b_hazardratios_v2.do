...
tempname hazardratios
	...
	using $resultsdir/option1_table3b_hazardratios_v2.dta, replace
	local outindex=0
...
use $resultsdir/option1_table3b_hazardratios_v2.dta, clear
...
save $resultsdir/option1_table3b_hazardratios_v2.dta, replace
