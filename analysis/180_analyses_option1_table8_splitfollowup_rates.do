...
tempname rates
	...
	using $resultsdir/option1_table8_splitfollowup_rates.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/option1_table8_splitfollowup_rates.dta, clear
...
save $resultsdir/option1_table8_splitfollowup_rates.dta, replace
