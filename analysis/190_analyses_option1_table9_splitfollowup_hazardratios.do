...
**// Split follow-up hazard ratios - groups 1,2 and 3
**///////////////////////////////////////////////////
...
tempname hazardratios
	...
	using $resultsdir/option1_table9_splitfollowup_hazardratios.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/option1_table9_splitfollowup_hazardratios.dta, clear
...
save $resultsdir/option1_table9_splitfollowup_hazardratios.dta, replace
