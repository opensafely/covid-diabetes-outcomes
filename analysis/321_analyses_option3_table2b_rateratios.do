...
tempname rates
	...
	using $resultsdir/option3_table2b_rateratios.dta, replace
	**// Loop over outcomes
	local outindex=0
...
use $resultsdir/option3_table2b_rateratios.dta, clear
...
save $resultsdir/option3_table2b_rateratios.dta, replace
