...
tempname hazardratios
	...
	using $resultsdir/option3_table3b_hazardratios_v2.dta, replace
	local outindex=0
...
use $resultsdir/option3_table3b_hazardratios_v2.dta, clear
...
save $resultsdir/option3_table3b_hazardratios_v2.dta, replace
