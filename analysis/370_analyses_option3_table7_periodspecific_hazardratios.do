...
tempname hazardratios
	...
	$resultsdir/option3_table7_periodspecific_hazardratios.dta, replace
	local outindex=0
...
use $resultsdir/option3_table7_periodspecific_hazardratios.dta, clear
...
save $resultsdir/option3_table7_periodspecific_hazardratios.dta, replace
