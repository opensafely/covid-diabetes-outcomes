...
tempname rates
	...
	using $resultsdir/option3_table8_splitfollowup_rates.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/option3_table8_splitfollowup_rates.dta, clear
...
save $resultsdir/option3_table8_splitfollowup_rates.dta, replace
