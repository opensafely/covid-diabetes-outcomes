...
tempname hazardratios
	...
	using $resultsdir/option3_table9_splitfollowup_hazardratios.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/option3_table9_splitfollowup_hazardratios.dta, clear
...
save $resultsdir/option3_table9_splitfollowup_hazardratios.dta, replace
