		...
		forvalues catindex=1(1)`numcat_`demog'' {
			...
			**// Calculate rates and rate ratios
			...
			tempname rates
				...
				`outcome'_rr `outcome'_rr_lo `outcome'_rr_hi ///	
				`outcome'_adj_rr `outcome'_adj_rr_lo `outcome'_adj_rr_hi ///
				`outcome'_fuladj_rr `outcome'_fuladj_rr_lo `outcome'_fuladj_rr_hi ///
				`outcome'_ipw_rr `outcome'_ipw_rr_lo `outcome'_ipw_rr_hi ///
				`outcome'_sipw_rr `outcome'_sipw_rr_lo `outcome'_sipw_rr_hi ///			
...
save $resultsdir/part2_option1_table4b_stratified_rateratios.dta, replace
