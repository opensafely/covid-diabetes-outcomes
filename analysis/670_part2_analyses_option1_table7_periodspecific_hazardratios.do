...
**// Period-specific hazard ratios - groups 1 and 2
**/////////////////////////////////////////////////////
...
tempname hazardratios
	...
	$resultsdir/part2_option1_table7_periodspecific_hazardratios.dta, replace
	local outindex=0
...
use $resultsdir/part2_option1_table7_periodspecific_hazardratios.dta, clear
...
save $resultsdir/part2_option1_table7_periodspecific_hazardratios.dta, replace
