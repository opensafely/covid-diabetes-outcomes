...
tempname hazardratios
	...
	using $resultsdir/part2_option1_table9_splitfollowup_hazardratios.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/part2_option1_table9_splitfollowup_hazardratios.dta, clear
...
save $resultsdir/part2_option1_table9_splitfollowup_hazardratios.dta, replace
