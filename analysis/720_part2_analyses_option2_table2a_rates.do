...
tempname rates
	postfile `rates' outindex groupindex str30(outcome) str30(group) person_time numevents rate rate_lo rate_hi using $resultsdir/part2_option2_table2a_rates.dta, replace
	**// Outcomes
	local outindex=0
...
use $resultsdir/part2_option2_table2a_rates.dta, clear
...
save $resultsdir/part2_option2_table2a_rates.dta, replace
