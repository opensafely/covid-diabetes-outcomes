...
tempname hazardratios
	...
	$resultsdir/part2_option2_table7_periodspecific_hazardratios.dta, replace
	local outindex=0
...
use $resultsdir/part2_option2_table7_periodspecific_hazardratios.dta, clear
...
save $resultsdir/part2_option2_table7_periodspecific_hazardratios.dta, replace
