...
capture noisily use $revisedresultsdir/revised2_option1_table2b_rateratios.dta, clear
if _rc==0 {
	if _N>0 {
	...
	save $revisedresultsdir/revised2_option1_table2b_rateratios_redacted.dta, replace
	export delimited using $revisedresultsdir/revised2_option1_table2b_rateratios_redacted.csv, replace
}
