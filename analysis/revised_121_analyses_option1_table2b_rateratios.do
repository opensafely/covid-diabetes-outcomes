...
tempname rates
	postfile `rates' outindex groupindex str30(outcome) str30(group) person_time numevents rate rate_lo rate_hi ipw_rateratio ipw_rateratio_lo ipw_rateratio_hi ///
	check check_lo check_hi ///
	using $revisedresultsdir/revised_option1_table2b_rateratios.dta, replace
	**// Loop over outcomes
	local outindex=0
...
use $revisedresultsdir/revised_option1_table2b_rateratios.dta, clear
...
save $revisedresultsdir/revised_option1_table2b_rateratios.dta, replace
