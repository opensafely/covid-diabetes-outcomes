...
capture noisily use $revisedresultsdir/revised_option1_table1_demographics.dta, clear
if _rc==0 {
	if _N>0 {
		describe *_n, varlist
	...
	save $revisedresultsdir/revised_option1_table1_demographics_redacted.dta, replace
	export delimited using $revisedresultsdir/revised_option1_table1_demographics_redacted.csv, replace
}

**// Option 1: Table 2b. Rate ratios
capture noisily use $revisedresultsdir/revised_option1_table2b_rateratios.dta, clear
if _rc==0 {
	if _N>0 {
	...
	save $revisedresultsdir/revised_option1_table2b_rateratios_redacted.dta, replace
	export delimited using $revisedresultsdir/revised_option1_table2b_rateratios_redacted.csv, replace
}

**// Option 1: Table 4b. Stratified rate ratios
capture noisily use $revisedresultsdir/revised_option1_table4b_stratified_rateratios.dta, clear
if _rc==0 {
	if _N>0 {
	...
	save $revisedresultsdir/revised_option1_table4b_stratified_rateratios_redacted.dta, replace
	export delimited using $revisedresultsdir/revised_option1_table4b_stratified_rateratios_redacted.csv, replace
}
