...
tempname demographics
	postfile `demographics' str20(demographic) category covid_diab_n covid_diab_pmonths covid_nodiab_n covid_nodiab_pmonths nocovid_diab_n nocovid_diab_pmonths using ///
	$revisedresultsdir/revised_part2_option1_table1_demographics.dta, replace
...
use $revisedresultsdir/revised_part2_option1_table1_demographics.dta, clear
...
format covid_diab_pmonths covid_nodiab_pmonths nocovid_diab_pmonths %12.1f
save $revisedresultsdir/revised_part2_option1_table1_demographics.dta, replace
