...
if _rc==0 {
	...
	save $tempresultsdir/revised_part2_option1_table1_demographics_redacted.dta, replace
	export delimited using $tempresultsdir/revised_part2_option1_table1_demographics_redacted.csv, replace
}
...
if _rc==0 {
	...
	save $tempresultsdir/revised_part2_option1_table2b_rateratios_redacted.dta, replace
	export delimited using $tempresultsdir/revised_part2_option1_table2b_rateratios_redacted.csv, replace
}

**// Part 2, Option 1: Table 4b. Stratified rate ratios
capture noisily use $tempresultsdir/revised_part2_option1_table4b_reduc.dta, clear
if _rc==0 {
	if _N>0 {
	...
	save $tempresultsdir/revised_part2_option1_table4b_reduc_redacted.dta, replace
	export delimited using $tempresultsdir/revised_part2_option1_table4b_reduc_redacted.csv, replace
}
