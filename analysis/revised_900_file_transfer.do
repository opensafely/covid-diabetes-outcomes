...
global revisedfinaldir $projectdir/revised_release
...
use $revisedresultsdir/revised_option1_table1_demographics_redacted.dta, clear
export delimited using $revisedfinaldir/revised_option1_table1_demographics_redacted.csv, replace

**// Option 1: Table 2b. Rate ratios
use $revisedresultsdir/revised_option1_table2b_rateratios_redacted.dta, clear
export delimited using $revisedfinaldir/revised_option1_table2b_rateratios_redacted.csv, replace

**// Option 1: Table 4b. Stratified rate ratios
use $revisedresultsdir/revised_option1_table4b_stratified_rateratios_redacted.dta, clear
export delimited using $revisedfinaldir/revised_option1_table4b_stratified_rateratios_redacted.csv, replace
